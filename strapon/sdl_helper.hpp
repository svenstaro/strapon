...
static void draw_text(SDL_Renderer renderer, ResourceManager resource_manager, std::string text, std::string font_key, int x_pos, int y_pos, int char_width, int char_height, SDL_Color color)
{
