...
class DebugDraw : public btIDebugDraw {
  public:
    ...
    /**
     * @brief Converts a Bullet color (float 0.0f - 1.0f range) to an SDL color (Uint8 0 - 255
     * range)
    ...
    // void drawLine(const btVector3 &from, const btVector3 &to, const btVector3 &fromColor, const
    // btVector3 &toColor);
    ...
    // void drawTriangle(const btVector3 &v0, const btVector3 &v1, const btVector3 &v2, const
