...
/*
void DebugDraw::drawLine(const btVector3& from, const btVector3& to, const btVector3& from_color,
...
void DebugDraw::drawSphere(btScalar radius, const btTransform& transform, const btVector3& color) {
    auto c = btToSDLColor(color);
    aacircleRGBA(m_Renderer, transform.getOrigin().x(), transform.getOrigin().y(), radius, c.r, c.g,
c.b, 255);
}
...
void DebugDraw::drawTriangle(const btVector3 &v0, const btVector3 &v1, const btVector3 &v2, const
btVector3 &color, btScalar) {
    auto c = btToSDLColor(color);
    aatrigonRGBA(m_Renderer, v0.x(), v0.y(), v1.x(), v1.y(), v2.x(), v2.y(), c.r, c.g, c.b, 255);
}
*/

void DebugDraw::drawContactPoint(const btVector3 &point_on_b, const btVector3 &normal_on_b,
